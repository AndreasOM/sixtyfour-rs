...
pub struct StepEditorSetUniformF64 {}

impl StepEditorSetUniformF64 {}

impl StepEditor for StepEditorSetUniformF64 {
    fn update(
        &self,
        ui: &mut egui::Ui,
        project: &Project,
        ...
        match step {
            Step::SetUniformF64 { name, value, .. } => {
                ...
                if committed {
                    ...
                    let _ = COMMAND_QUEUE.send(Command::HackStepSetUniformF64SetNameAndValue {
